...
if (isset($_POST['btnregister'])) {
    ...
    $track_number = $_POST['txttrack_number'];
    $faculty = $_POST['cmdfaculty'];
    $dept = $_POST['cmddept'];


 $sql = "SELECT * FROM students where track_number='$track_number' or email='$email'";
$result = mysqli_query($conn, $sql);

if (mysqli_num_rows($result) > 0) {
$_SESSION['error'] =' Track Number Address or Email Address already Exist ';
