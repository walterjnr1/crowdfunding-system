...
<div class="login-container">
        ...
        <form action="login.php" method="post">
            ...
            <input type="email" id="txtamount" name="txtamount" required>

            <button type="submit" name="btnpay">Pay</button>
        </form>
</div>
<input type="hidden" id="hidpublickey" name="hidpublickey" value="<?php echo $publickey; ?>"> </p>
    ...
    <input type="hidden" id="hidtotal" name="hidamount" value="<?php echo $total; ?>"> </p>
