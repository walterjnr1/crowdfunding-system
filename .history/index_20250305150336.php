...
<body>
    ...
    <section class="campaigns">
        <div class="container">
            ...
            <div class="row">
            <?php
                            $sql = "SELECT students.*,requests.photo as campain image,requests.* FROM students INNER JOIN requests ON students.track_number = requests.student_id order by requests.id asc";
              ...
              <div class="col-md-4">
                    <div class="card">
                        <img src="../<?php echo $row['photo'] ?>" alt="Campaign Image" class="card-img-top">
                        <div class="card-body">
