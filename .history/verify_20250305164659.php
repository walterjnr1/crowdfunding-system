...
header("Location:javascript://history.go(-1)");
  ...
  //save payment details
    $sql = 'INSERT INTO payments(payment_id,description,amount,payment_date,channel) VALUES(:user,:payment_id,:description,:amount,:payment_date,:channel)';
    ...
    $statement->execute([
        ...
        ':amount'   => 'booking',
        ':student_id'   => $amount,
         ':donor_name'   => $current_date,
         ':channel'   => 'Paystack',
         ':payment_date'   => $current_date,
         ':donor_email'   => $current_date,
