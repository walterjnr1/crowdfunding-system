...
<body>
    ...
    <section class="campaigns">
        <div class="container">
            ...
            <div class="row">
            <?php
                            $sql = "SELECT students.*,requests.photo as campaimage,requests.* FROM students INNER JOIN requests ON students.track_number = requests.student_id order by requests.id asc";
