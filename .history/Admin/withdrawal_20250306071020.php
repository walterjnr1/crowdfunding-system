                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                <div class="form-group">
                                                                    <input name="txtamount" type="text"
                                                                        class="form-control" value="<?php echo $balance?>" disabled>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input name="txtname" type="text"
                                                                        class="form-control" value="<?php echo $student_name; ?>" disabled>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input name="txtbank" type="text"
                                                                        class="form-control" value="<?php echo $bank; ?>" disabled>
                                                                </div>
                                                                <div class="form-group">
                                                                    <input name="txtaccount_number" type="text" class="form-control" value="<?php echo $account_number; ?>" disabled>
                                                                </div>
                                                        ...
                                                        <div class="row">
                                                            <div class="col-lg-3">
                                                                <div class="payment-adress">
                                                                    <button type="submit"
                                                                        class="btn btn-primary waves-effect waves-light" name="btnwithdraw">Withdraw</button>
                                                                </div>
                                                            </div>
                                                        </div>
                                                  </form>
