                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                ...
                                                                <div class="form-group">
                                                                    <select name="cmddept" class="form-control">
                                                                        ...
                                                                        <option value="1">Female</option>
                                                                      <option value="0">Male</option> 
                                                                      <option value="0">Male</option> <option value="0">Male</option> <option value="0">Male</option> <option value="0">Male</option> <option value="0">Male</option> <option value="0">Male</option> <option value="0">Male</option>   <option value="0">Male</option>
