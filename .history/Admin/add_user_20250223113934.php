...
//save user details
$query = "INSERT into `user` (email,password,fullname,status)
VALUES ('$email','$username','$password','Super Admin','$email','1','Not Available','Not Available','uploadImage/Profile/photo_not_available_large.png')";
