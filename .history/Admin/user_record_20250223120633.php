...
<div class="all-content-wrapper">
        ...
        <div class="data-table-area mg-b-15">
            <div class="container-fluid">
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        <div class="sparkline13-list">
                            ...
                            //$sql = "SELECT tblusers.name,tblbooking.*,places.name as place_name FROM tblusers INNER JOIN tblbooking ON tblusers.username = tblbooking.user INNER JOIN places ON tblbooking.place = places.id order by tblbooking.id asc";
                                $sql = "SELECT * FROM users where role = order by id asc";
              ...
              <a button class="btn btn-success"  href="enable_disable_user.php?id=<?php echo $row['id'];?>" onClick="return disable();">Disable</button></a>
					  <?php } else {?>
              <a button class="btn btn-success"  href="enable_disable_user.php?uid=<?php echo $row['id'];?>" onClick="return enable();">Enable</button></a>
					  <?php } ?></td>
