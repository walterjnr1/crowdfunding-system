...
<script type="text/javascript">
		function deldata(){
if(confirm("ARE YOU SURE YOU WISH TO DE THIS ACCOUNT ?" ))
{
return  true;
}
else {return false;
        ...
        <div class="data-table-area mg-b-15">
            <div class="container-fluid">
              ...
              <a button class="btn btn-success"  href="enable_disable_user.php?did=<?php echo $row['id'];?>" onClick="return disable();">Disable</button></a>
					  <?php } ?>
                      <a button class="btn btn-danger"  href="delete_user.php?id=<?php echo $row['id'];?>" onClick="return deldata();">Delete</button></a>
