        ...
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                    <div class="logo-pro">
                        <a href="index.php"><img class="main-logo" src="../uploadImage/Logo/logo.png/"
                                alt="" /></a>
                    </div>
                </div>
            </div>
                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                ...
                                                                <div class="form-group">
                                                                    <select name="cmddept" class="form-control">
                                                                        ...
                                                                        <option value="0">Male</option>
                                                                        <option value="1">Female</option>
                                                                      <option value="0">Male</option> <option value="0">Male</option> <option value="0">Male</option> <option value="0">Male</option> <option value="0">Male</option> <option value="0">Male</option> <option value="0">Male</option> <option value="0">Male</option>   <option value="0">Male</option>
                                                                        <option value="1">Female</option> <option value="0">Male</option>
                                                                        <option value="1">Female</option> <option value="0">Male</option>
                                                                        <option value="1">Female</option> <option value="0">Male</option>
                                                                        <option value="1">Female</option> <option value="0">Male</option>
                                                                        <option value="1">Female</option> <option value="0">Male</option>
                                                                        <option value="1">Female</option>                                                                        <option value="1">Female</option>                                                                        <option value="1">Female</option>                                                                        <option value="1">Female</option>                                                                        <option value="1">Female</option>                                                                        <option value="1">Female</option>                                                                        <option value="1">Female</option>                                                                        <option value="1">Female</option>                                                                        <option value="1">Female</option>
