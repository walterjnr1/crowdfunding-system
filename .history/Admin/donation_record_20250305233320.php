                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="photo"><div align="center">Title</div></th>
                                                <th data-field="name" data-editable="true"><div align="center">Amount</div></th>
                                                <th data-field="track_number" data-editable="true"><div align="center">Donor</div></th>
                                                <th data-field="email" data-editable="true"><div align="center">Date of Paymewnt</div></th>
                                      ...
                                      while($row = $result->fetch_assoc()) {
										  ...
										  ?>
                                             <tr>
                                                <td></td>
                                                <td><?php echo $cnt;  ?></td>
                                                <td><img src="../<?php echo $row['photo'];  ?>" alt="studnt Photo" style="max-width: 70px; max-height: 70px;"></td>
