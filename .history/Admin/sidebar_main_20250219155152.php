                    ...
                    <li class="active">
                        ...
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                ...
                                <li><a title="User Record" href="user_record.php"><span class="mini-sub-pro">User Records</span></a></li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                ...
                                <li><a title="Students Record" href="student_record.php"><span class="mini-sub-pro">Student Record</span></a></li>
                            </ul>
                        </li>
                        <li>
                            ...
                            <ul class="submenu-angle" aria-expanded="false">
                                <li><a title="All Courses" href="all-courses.html"><span class="mini-sub-pro">All Payment</span></a></li>
