...
<head>
<title>User Record  | <?php echo $sitename; ?></title>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                        <ul class="breadcome-menu">
                                            ...
                                            <li><span class="bread-blod">User Record</span>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                    ...
                                    <table id="table" data-toggle="table" data-pagination="true" data-search="true" data-show-columns="true" data-show-pagination-switch="true" data-show-refresh="true" data-key-events="true" data-show-toggle="true" data-resizable="true" data-cookie="true"
                                        ...
                                        <thead>
                                            <tr>
                                                ...
                                                <th data-field="name" data-editable="true">Fullname</th>
                                                <th data-field="email" data-editable="true">Email</th>
                                                <th data-field="date" data-editable="true">Photo</th>
...
$sql = "SELECT * FROM tblusers INNER JOIN tblbooking ON tblusers.username = tblbooking.user INNER JOIN places ON tblbooking.place = places.id order by tblbooking.id asc";
                   ...
                   while($row = $result->fetch_assoc()) {
										  ...
										  ?>
                                             <tr>
                                                ...
                                                <td>21</td>
                                                 <td>Ndueso Walter</td>
                                                <td>newletpaysolution@gmail.com</td>
                                                <td>newletpaysolution@gmail.com</td>
                                                <td><?php if (($row['status'])==(('0')))  { ?>
              <a button class="btn btn-success"  href="approve_finish_tour.php?id=<?php echo $row['id'];?>" onClick="return disable();">Disable</button></a>
					  <?php } else {?>
              <a button class="btn btn-success"  href="approve_finish_tour.php?uid=<?php echo $row['id'];?>" onClick="return enable();">Enable</button></a>
					  <?php } ?></td>
