                ...
                <div class="row">
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="analytics-sparkle-line reso-mg-b-30">
                            <div class="analytics-content">
                                ...
                                <h2><span class="counter">N<?php echo number_format((float) $row_amount['amount'], 2); ?></span></h2>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="analytics-sparkle-line table-mg-t-pro dk-res-t-pro-30">
                            <div class="analytics-content">
                                <h5>Last Login Date<?php echo $last_access; ?></h5>
                                <h2><span class="counter"><?php echo $last_access; ?></span> </h2>
