                                                            ...
                                                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                                                                ...
                                                                <div class="form-group">
                                                                    <select name="country" class="form-control">
                                                                        ...
                                                                        <option value="4">Fairmoney</option>
                                                                        <option value="5">Sterling Bank</option>
                                                                        <option value="5">Union Bank</option>                                                                        <option value="5">Sterling Bank</option>
                                                                        <option value="5">United Bank for Africa</option>                                                                        <option value="5">Sterling Bank</option>
