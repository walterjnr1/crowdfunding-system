<nav class="sidebar-nav left-sidebar-menu-pro">
                    ...
                    <li class="active">
                            <a title="Home Page" href="events.html" aria-expanded="false"><span class="educate-icon educate-home icon-wrap sub-icon-mg" aria-hidden="true"></span> <span class="mini-click-non">Event</span></a>
                         </li>
