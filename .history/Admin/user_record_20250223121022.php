            ...
            <div class="container-fluid">
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                      ...
                      <td><?php if (($row['status'])==(('0')))  { ?>
              <a button class="btn btn-success"  href="enable_disable_user.php?eid=<?php echo $row['id'];?>" onClick="return disable();">Enable</button></a>
					  <?php } else {?>
              <a button class="btn btn-success"  href="enable_disable_user.php?uid=<?php echo $row['id'];?>" onClick="return enable();">Disable</button></a>
					  <?php } ?></td>
