...
$row_user= $stmt->fetch();
$last_access=$row_user['lastaccess'];
?>
<!doctype html>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="analytics-sparkle-line reso-mg-b-30">
                            <div class="analytics-content">
                                ...
                                <h2><span class=""><?php echo $row_student ?></span> </h2>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="analytics-sparkle-line reso-mg-b-30">
                            <div class="analytics-content">
                                ...
                                <h2><span class="">N<?php echo number_format((float) $row_amount['amount'], 2); ?></span></h2>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="analytics-sparkle-line reso-mg-b-30 table-mg-t-pro dk-res-t-pro-30">
                            <div class="analytics-content">
                                ...
                                <h2><span class=""><?php echo $row_applications ?></span> </h2>
                    ...
                    <div class="col-lg-3 col-md-6 col-sm-6 col-xs-12">
                        <div class="analytics-sparkle-line table-mg-t-pro dk-res-t-pro-30">
                            <div class="analytics-content">
                                ...
                                <h2><span class=""><?php echo $lastaccess; ?></span> </h2>
