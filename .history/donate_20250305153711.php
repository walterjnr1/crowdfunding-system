...
function payWithPaystack(e) {
  ...
  let handler = PaystackPop.setup({
    ...
    alert(message);
    window.location="http://localhost/crowdfunding/verify.php?amount="+encodeURIComponent(document.getElementById("txtamount").value)+"&email=" +encodeURIComponent(document.getElementById("txtemail").value)+"&place=" +encodeURIComponent(document.getElementById("hidplace").value)+"&start=" +encodeURIComponent(document.getElementById("hidstart").value)+"&end=" +encodeURIComponent(document.getElementById("hidend").value)+"&reference=" + response.reference    }
  });
