              ...
              <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <button class="btn btn-success btn-lg" onClick="window.location.href='donate.php?requestid=<?php echo $row['requestid'] ?>&studentid=<?php echo $row['track'] ?>'">Donate</button>
                        </div>
                    </div>
                </div>
                <?php } ?>
