...
<p><strong>Payment ID : </strong> $booking_id</p>
<p><strong>Request ID : </strong> $booking_id</p>
<p><strong>Student Name : </strong> $booking_id</p>
...
$_SESSION['success']='Doation received Successfully...';


 header("Location: index.php?place=$placeid&start=$start&end=$end&amount=$amount&ref=$ref");
