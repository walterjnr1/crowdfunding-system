...
<body>
    ...
    <section class="campaigns">
        <div class="container">
            ...
            <div class="row">
            <?php
$sql = "  SELECT students.*,  requests.photo as Campaign_image, requests.*, ( SELECT SUM(amount) FROM payment WHERE request_id = requests.id ) as total_donation FROM students INNER JOIN requests ON students.track_number = requests.student_id 
