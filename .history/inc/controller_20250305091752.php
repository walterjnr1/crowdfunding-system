...
//fetch number of request using requests table where track_number 
$stmt = $dbh->query("SELECT * FROM requests where track_number='$track_number'");
$number_of_request = $stmt->rowCount();
