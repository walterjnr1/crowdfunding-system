    ...
    <section class="campaigns">
        <div class="container">
            ...
            <?php
              ...
              <div class="col-md-4">
                    <div class="card">
                        <img src="<?php echo $row['Campaign_image']; ?>" alt="Campaign Image" class="card-img-top" height="110" width="60">
                        <div class="card-body">
                            <h5 class="card-title"><?php echo $row['title'] ?></h5>
                            <p class="card-text"><?php echo $row['description'] ?></p>
                            <p class="card-text">Raised: $3000 / Goal: N<?php echo number_format((float) $row['balance'] ,2); ?></p>
                            <button class="btn btn-primary btn-lg" onClick="window.location.href='student/request.php'">Start a Campaign</button>
                        </div>
                    </div>
                </div>
