    ...
    <div class="content">
      ...
      <div class="table-responsive">
                ...
                <tbody>
                      ...
                      <?php
                          $sql = "SELECT students.*,requests.* FROM students INNER JOIN requests ON students.track_number = requests.student_id where student_id='$track_number'order by requests.id asc ";
