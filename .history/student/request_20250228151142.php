     ...
     <form  action="" method="POST" enctype="multipart/form-data">
		...
		<input type="password" class="form-control" id="txttitle" name="txttitle" value="<?php if (isset($_POST['txttitle']))?><?php echo $_POST['txttitle']; ?>" required>
              ...
              <div class="form-group">
                ...
                <div align="center"><img src="../<?php echo $student_photo;   ?>" alt="student photo" width="178" height="154" id="logo-img">   
                                                </div>
                 <input type="file" name="txtdeadline" class="form-control" id="refamount" value="<?php if (isset($_POST['txtdeadline']))?><?php echo $_POST['txtdeadline']; ?>"  required>
              </div>
