...
<title>Donation Records|<?php echo $sitename ;?></title>
 ...
 <?php include('sidebar.php'); ?>
  ...
  <div class="content-wrapper"> 
    ...
    <div class="content">
      ...
      <div class="card-body">
      <h4 class="text-black">Donation Records</h4>
      <p>&nbsp;</p>
      <div class="table-responsive">
                ...
                <?php
                          $sql = "SELECT students.*,requests.*,payments.* FROM students INNER JOIN requests ON students.track_number = requests.student_id INNER JOIN payments ON payments.student_id = students.track_number  where students.track_number='$track_number' order by payments.id asc ";
