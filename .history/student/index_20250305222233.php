                ...
                <div class="table-responsive">
                  <div align="center">
                    <table width="114%" height="87" class="table table-hover">
                      ...
                      <tbody>
                      <?php
$sql = "SELECT students.*, requests.*, payment.* FROM students INNER JOIN requests ON students.track_number = requests.student_id 
INNER JOIN payment ON requests.id = payment.request_id ORDER BY requests.id ASC";									      	 $result = $conn->query($sql);
                           $cnt=1;
