...
if (isset($_POST["btnsave"])) {
    ...
    $query = "INSERT INTO requests (requestid,student_id title, description, amount, deadline,status image_path) VALUES ('$request_id', '$title', '$description', '$amount', '$deadline', '$image_path')";
