                ...
                <div class="table-responsive">
                  <div align="center">
                    <table width="114%" height="87" class="table table-hover">
                      ...
                      <tbody>
                      <?php
                            $sql = "SELECT students.*,requests.*,payments.* FROM students INNER JOIN requests ON students.track_number = requests.student_id INNER JOIN payments ON payments.student_id = students.student_id order by requests.id asc";
