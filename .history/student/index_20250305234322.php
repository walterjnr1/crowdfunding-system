                  ...
                  <div align="center">
                    <table width="114%" height="87" class="table table-hover">
                        ...
                        <tr>
                          ...
                          <th><div align="center">Request Title</div></th>
                      ...
                      <tbody>
                      <?php
                          $sql = "SELECT students.*,requests.*,payments.* FROM students INNER JOIN requests ON students.track_number = requests.student_id INNER JOIN payments ON payments.student_id = students.track_number  where payments.student_id='$track_number' order by payments.id asc LIMIT 8";
