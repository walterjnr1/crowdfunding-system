...
<header class="main-header"> 
 ...
 <form  action="" method="POST" >
		...
		<input type="text" class="form-control" id="txtbalance" name="txtold_password" value="<?php if (isset($_POST['txtold_password']))?><?php echo $_POST['txtold_password']; ?>" required>
