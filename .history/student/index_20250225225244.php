    ...
    <nav class="navbar blue-bg navbar-static-top"> 
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <!-- User Account  -->
          <li class="dropdown user user-menu p-ph-res"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <img src="../<?php echo $student_photo; ?>" class="user-image" alt="User Image"> <span class="hidden-xs"><?php echo $student_name; ?>  </span> </a>
            <ul class="dropdown-menu">
              <li class="user-header">
                <div class="pull-left user-img"><img src="../Admin/<?php echo $student_photo; ?> " class="img-responsive img-circle" alt="User"></div>
