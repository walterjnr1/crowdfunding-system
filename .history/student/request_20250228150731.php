              ...
              <?php if (isset($_POST['txtdescription'])) echo $_POST['txtdescription']; ?>
			   ...
			   <div class="form-group">
                <label for="exampleInputEmail1">Amount</label>
                 <input type="number" name="txtamount" class="form-control" id="refamount" value="<?php if (isset($_POST['txtconfirm_password']))?><?php echo $_POST['txtconfirm_password']; ?>"  required>
              </div>
