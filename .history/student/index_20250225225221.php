    ...
    <nav class="navbar blue-bg navbar-static-top"> 
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <!-- User Account  -->
          <li class="dropdown user user-menu p-ph-res"> <a href="#" class="dropdown-toggle" data-toggle="dropdown"> <img src="../<?php echo $student_photo; ?>" class="user-image" alt="User Image"> <span class="hidden-xs"><?php echo $row_cust['fullname']; ?>  </span> </a>
