                ...
                <div class="table-responsive">
                  <div align="center">
                    <table width="114%" height="87" class="table table-hover">
                      ...
                      <tbody>
                      <?php
                            $sql = "SELECT students.*,requests.*,payments.*,payments.payment_date as  FROM students INNER JOIN requests ON students.track_number = requests.student_id INNER JOIN payments ON requests.id = payments.request_id order by payments.id asc";
