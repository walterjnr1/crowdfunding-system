...
<header class="main-header"> 
 ...
 <?php } ?></p>
             ...
             <form  action="" method="POST" enctype="multipart/form-data">
                      ...
                      <option value="<?php echo $faculty;  ?>" selected=""disabled=""><?php echo $dept;  ?></option>
                      ...
                      <div class="form-group">
                        ...
                        <div class="col-md-12">
                          <input class="form-control form-control-line" name="txtaccount_number" type="text" value="<?php echo $student_email; ?>">
                        </div>
                      </div>
                        <div class="form-group">
