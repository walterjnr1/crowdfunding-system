...
if(isset($_POST["btnwithdrawal"])){
      ...
      $bank = mysqli_real_escape_string($conn,$_POST['txtbank']);
      $account_number = mysqli_real_escape_string($conn,$_POST['txtaccount_number']);
      $amount = mysqli_real_escape_string($conn,$_POST['txtbalance']);

      //update student balance
      $sql = "update students set `balance`= balance - '$amount' where track_number='$track_number'";
      $res = $conn->query($sql);

      //save withdrawal history
      $query = "INSERT INTO withdrawal (student_id, amount, bank,account_number, withdrawal_date) VALUES ('$track_number',  '$amount','$bank','$account_number', '$current_date')";
...
<p>Your Request for withdrawal has been created submited successfully.</p>
<p>You will be credited within 24 hours.</p>


<p><strong>Amount : </strong> $request_id</p>
<p><strong>Bank : </strong> $Approved</p>
<p><strong>Account Number : </strong> $track_number</p>
...
<header class="main-header"> 
 ...
 <form  action="" method="POST" onsubmit="return confirm('Are you sure you want to withdraw?');">
              
              <div class="form-group">
         	    <label for="exampleInputEmail1">Balance</label>
        		<input type="text" class="form-control" id="txtbalance" name="txtbalance" value="<?php echo $balance; ?>" readonly>
              </div>

              <div class="form-group">
         	    <label for="exampleInputEmail1">Account Name</label>
        		<input type="text" class="form-control" id="txtname" name="txtname" value="<?php echo $student_name; ?>" readonly>
              </div>
              
              <div class="form-group">
         	    <label for="exampleInputEmail1">Bank</label>
        		<input type="text" class="form-control" id="txtbank" name="txtbank" value="<?php echo $bank; ?>" readonly>
              </div>

              <div class="form-group">
         	    <label for="exampleInputEmail1">Account Number</label>
        		<input type="text" class="form-control" id="txtaccount_number" name="txtaccount_number" value="<?php echo $account_number; ?>" readonly>
              </div>

              
		      <button type="submit" name="btnwithdrawal" class="btn btn-primary" >Withdraw</button>
