...
$sql = "UPDATE students SET fullname=?, email=?,faculty=?, dept=?, bank=?,account_number=? where track_number=?";
$stmt= $dbh->prepare($sql);
$stmt->execute([$this_fullname,$this_email,$this_faculty,$this_dept, $this_bank,$this_account_number,$nextkin,$company,$track_number]);
if($stmt) {
