  ...
  <div class="content-wrapper"> 
    ...
    <div class="content">
      ...
      <div class="table-responsive">
                ...
                <?php
                          $sql = "SELECT students.*,requests.*,payments.* FROM students INNER JOIN requests ON students.track_number = requests.student_id INNER JOIN payments ON payments.student_id = students.track_number  where students.student_id='$track_number' order by payments.id asc ";
