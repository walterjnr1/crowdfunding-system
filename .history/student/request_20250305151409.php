...
if (isset($_POST["btnsave"])) {
    ...
    move_uploaded_file($_FILES["image"]["tmp_name"],"../uploadImage/Request/" . $_FILES["image"]["name"]);			
    $image_path="uploadImage/Request/" . $_FILES["image"]["name"];
...
<header class="main-header"> 
 ...
 <?php } ?>
     <form  action="" method="POST" enctype="multipart/form-data">
		...
		<input type="text" class="form-control" id="txttitle" name="txttitle" maxlength="45" value="<?php if (isset($_POST['txttitle']))?><?php echo $_POST['txttitle']; ?>" required>
              </div>
			  <div class="form-group">
                <label for="exampleInputEmail1">Description</label>
                <textarea class="form-control" id="refplotno" maxlength ="number" name="txtdescription" required>
