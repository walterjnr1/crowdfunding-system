      ...
      <div class="row">
        <div class="col-lg-4">
          <div class="user-profile-box m-b-3">
            <div class="box-profile text-white"> <img class="profile-user-img img-responsive img-circle m-b-2" src="../<?php echo $row_customer['photo']; ?>" alt="client profile picture">
          ...
          <div class="card m-b-3">
            <div class="card-body">
              ...
              <hr>
                ...
                <p>$<?php echo number_format((float)$balance ,2); ?></p>
              </div>
              <!-- /.box-body --> 
            </div>
          </div>
