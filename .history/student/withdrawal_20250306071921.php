...
$name = mysqli_real_escape_string($conn,$_POST['txtold_password']);
$bank = mysqli_real_escape_string($conn,$_POST['txtnew_password']);
$account_number = mysqli_real_escape_string($conn,$_POST['txtconfirm_password']);
$amount = mysqli_real_escape_string($conn,$_POST['txtconfirm_password']);
