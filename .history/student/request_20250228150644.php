...
<header class="main-header"> 
 ...
 <?php } ?>
     <form  action="" method="POST" enctype="multipart/form-data">
		...
		<input type="password" class="form-control" id="txttitle" name="txtold_password" value="<?php if (isset($_POST['txtold_password']))?><?php echo $_POST['txtold_password']; ?>" required>
              </div>
			  <div class="form-group">
