...
$sql = "UPDATE students SET name=?, email=?,faculty=?, dept=?, bank=?,account_number=? where track_number=?";
$stmt= $dbh->prepare($sql);
$stmt->execute([$this_fullname,$this_email,$this_faculty,$this_dept, $this_bank,$this_account_number,$track_number]);
if($stmt) {
...
<header class="main-header"> 
 ...
 <?php } ?></p>
             ...
             <form  action="" method="POST">
                      ...
                      <option value="<?php echo $faculty;  ?>" selected="<?php echo $faculty;  ?>"disabled="<?php echo $faculty;  ?>"><?php echo $faculty;  ?></option>
                      ...
                      <option value="<?php echo $dept;  ?>" selected="<?php echo $dept;  ?>"disabled="<?php echo $dept;  ?>"><?php echo $dept;  ?></option>
                      ...
                      <option value="<?php echo $bank;  ?>" selected="<?php echo $bank;  ?>"disabled="<?php echo $bank;  ?>"><?php echo $bank;  ?></option>
