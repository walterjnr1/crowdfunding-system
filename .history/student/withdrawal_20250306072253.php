...
//update student balance
  ...
  $query = "INSERT INTO withdrawal (requestid,student_id, title, description, amount, deadline,status, photo) VALUES 
    ('$request_id',  '$track_number','$title', '$description', '$amount', '$deadline', 'Approved','$image_path')";
