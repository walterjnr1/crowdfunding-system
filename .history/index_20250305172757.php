...
<body>
    ...
    <section class="campaigns">
        <div class="container">
            ...
            <div class="row">
            <?php
$sql = " SELECT students.*, requests.photo as Campaign_image, 
    requests.*, COALESCE(SUM(payments.amount), 0) as total_donation
FROM students INNER JOIN requests ON students.track_number = requests.student_id
LEFT JOIN payments ON requests.id = payments.request_id GROUP BY requests.id, students.track_number
              ...
              <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Raised: N<?php echo number_format((float) $total_donation ,2); ?> / Goal: N<?php echo number_format((float) $row['amount'] ,2); ?></p>
