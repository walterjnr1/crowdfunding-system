...
header("Location:javascript://history.go(-1)");
  ...
  //save payment details
    $sql = 'INSERT INTO payments(payment_id,request_id,student_id,donor_name,payment_date,channel) VALUES(:user,:payment_id,:description,:amount,:payment_date,:channel)';
