...
requests.*, 
COALESCE(SUM(payments.amount), 0) as total_amount_raised
FROM students 
INNER JOIN requests ON students.track_number = requests.student_id 
LEFT JOIN payments ON payments.request_id = requests.id 
              ...
              <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text">Raised: <?php echo $row['total_amount_raised']; ?> / Goal: N<?php echo number_format((float) $row['amount'] ,2); ?></p>
