              ...
              <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <button class="btn btn-success btn-lg" onClick="window.location.href='donate.php?requestid=<?php echo $row['requestid'] ?>&student<?php echo $row['studentid'] ?>'">Donate</button>
                        </div>
                    </div>
                </div>
                <?php } ?>
