...
if (isset($_POST['btnregister'])) {
    ...
    $dept = $_POST['cmddept'];
    $bank = $_POST['cmdbank'];
    $account_number = $_POST['txtaccount_number'];
...
//save admin details
$query = "INSERT into `students` (name,track_number,password,email,faculty,dept,bank,account_number,photo,status,balance)
VALUES ('$fullname','$tracknumber','$password1','$email','$faculty','$dept','$bank','$account_number','$uploadedImage','1','0')";
...
<p>Please keep it safe and do not share with anybody</p>
...
";
    ...
    $mail->Subject = 'Student Registration Details | Authur Javis University';
    $mail->Body = $message;
    $mail->send();
...
<option value="Arts and social science">Faculty Of Humanities Management And Social Sciences</option>
<option value="Faculty Of Basic Medical Sciences">Faculty Of Basic Medical Sciences</option>
<option value="Faculty Of Law">Faculty Of Law</option>
<option value="Faculty Of Education">Faculty Of Education</option>
</select>
