              ...
              <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p class="card-text"><strong>Raised</strong>: N<?php echo number_format((float) $row['balance'] ,2); ?> / <strong>Goal</strong>: N<?php echo number_format((float) $row['amount'] ,2); ?></p>
                            <button class="btn btn-success btn-lg" onClick="window.location.href='donate.php?requestid=<?php echo $row['requestid'] ?>&studentid=<?php echo $row['track_number'] ?>'">Donate</button>
                        </div>
                    </div>
                </div>
                <?php } ?>
